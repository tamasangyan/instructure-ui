...
| Badge                  | display            | `'inline-block' \| 'block'`                                         | No       | `'inline-block'`                          | Specifies the display property of the container. **Use "block" only when the content inside the Badge also has "block" display.**                                                                                          |
